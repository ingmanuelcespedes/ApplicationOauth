...
import COM.BEAN.McUsersItemMenuFacade;
...
public class McUsersItemMenuController implements Serializable {
    ...
    private McUsersItemMenu current;
    private DataModel items = null;
    @EJB
    private COM.BEAN.McUsersItemMenuFacade ejbFacade;
    ...
    public String prepareView() {
        current = (McUsersItemMenu) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("McUsersItemMenuCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("McUsersItemMenuUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("McUsersItemMenuDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class McUsersItemMenuControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof McUsersItemMenu) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + McUsersItemMenu.class.getName());
            }
        }
